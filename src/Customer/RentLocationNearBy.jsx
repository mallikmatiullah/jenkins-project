...
import RentImageSlider from "./RentImageSlider";
...
export default function RentLocationNearBy({ language }) {
    ...
    return (
        <>
            <Text fontSize="x-large" ml={"5rem"} mt={"2rem"}>{language === "en" ? "Location & Nearby - Rent" : "الموقع والقرب"}</Text>
            <Box
                borderWidth="1px"
                borderRadius="md"
                width={"60%"}
            ...
            <Box>
                <RentImageSlider language={language} />
            </Box>
        </>
    );
}
